---
title:  "<big><u>IMAP-PART 03</u></big><br><br>Downloading microbiome fastq sequences from SRA database<br><br>"
subtitle: |
  | ![](images/sra.png)<br>
...
A tentative snakemake workflow that defines **rules for downloading fastq sequences from SRA** in a DAG (directed acyclic graph) format. 
A detailed interactive snakemake report is available [here](https://complexdatainsights.com/imap/imap-download-sra-reads/report.html). Use a wider screen to get a better interactive snakemake report.
The interactive map of project sampling points is available [here.](https://complexdatainsights.com/imap/imap-sample-metadata/sample_gps.html) 


<br>

```{r child='workflow/scripts/01_get_sratoolkit.Rmd'}
```

<br>

```{r child='workflow/scripts/02_download_sequences.Rmd'}
```

<br>

```{r child='workflow/scripts/03_resizing_fastq.Rmd'}
```
